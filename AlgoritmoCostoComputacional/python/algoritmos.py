...
n_values_merge,t_values_merge=mimodulo(mergesort,1,100,1,numTrials=1,listMax=200)

n_values_insertion,t_values_insertion=mimodulo(InsertionSort,1,100,1,numTrials=1,listMax=200)
